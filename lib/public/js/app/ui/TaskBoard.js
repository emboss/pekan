...
dojo.declare("app.ui.TaskBoard", null, {
    ...
    _createColumns: function(columns) {
        dojo.forEach(columns, dojo.hitch(this, function(column) {
            ...
            app.AppRegistry.TaskBoard.containerNode.appendChild(columnNode);
        }));
    },
    ...
    _initEvents: function() {
        dojo.connect(app.AppRegistry.TaskBoard.addItemNode,
                     "onclick",
                     this.controller,
                     this.controller.onAddItem);

        dojo.connect(app.AppRegistry.TaskBoard.archiveItemNode,
                     "onclick",
                     this.controller,
                     this.controller.onArchiveTasks);

        dojo.connect(app.AppRegistry.TaskBoard.adminItemNode,
                     "onclick",
                     this.controller,
