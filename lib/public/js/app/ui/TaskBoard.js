...
dojo.require("app.TaskBoardRegistry");
...
dojo.declare("app.ui.TaskBoard", null, {
    ...
    _setupBoard: function() {
        this._createColumns(app.TaskBoardRegistry.columns);
    },
    ...
    _createColumns: function(columns) {
        dojo.forEach(columns, dojo.hitch(this, function(column) {
            ...
            app.TaskBoardRegistry.containerNode.appendChild(columnNode);
        }));
    },
    ...
    _initEvents: function() {
        dojo.connect(app.TaskBoardRegistry.addItemNode,
                     "onclick",
                     this.controller,
                     this.controller.onAddItem);

        dojo.connect(app.TaskBoardRegistry.archiveItemNode,
                     "onclick",
                     this.controller,
                     this.controller.onArchiveTasks);

        dojo.connect(app.TaskBoardRegistry.adminItemNode,
                     "onclick",
                     this.controller,
                     this.controller.onAdmin);
